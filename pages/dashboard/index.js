      ...
      <div className=" w-screen bg-white">
        <div className="flex justify-center items-center w-full bg-white">
          <div className="w-80 h-48 shadow-md border-[1px] border-black rounded-md text-center mx-10 ">
            ...
            <p className="mt-8 font-en-font text-5xl">{items.length}</p>
          </div>
          <div className="w-80 h-48 shadow-md border-[1px] border-black rounded-md text-center mx-10">
            <p className="mt-8 font-en-font text-xl">Total orders</p>
            <p className="mt-8 font-en-font text-5xl">{cartItems.length}</p>
          </div>
          <div className="w-80 h-48 shadow-md border-[1px] border-black rounded-md text-center mx-10">
            <p className="mt-8 font-en-font text-xl">Total sales</p>
            <p className="mt-8 font-en-font text-5xl">{sumPrice}</p>
          </div>
        </div>
        <div className="flex flex-col justify-center items-center">
          <p className="mt-20 font-en-font text-3xl">Pageviews</p>
          <div className="w-3/4 border-[1px] border-black h-[600px] shadow-inner bg-white mt-10 rounded-md mb-10 p-2">
